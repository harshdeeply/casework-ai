...
2. **Snapshot evidence at drafting time.** Store full selected attempts and a hash of the correlated ledger. If an attempt arrives before review, the reviewer must refresh. A runbook version is pinned to the case.
