...
function Card({ className, ...props }: React.ComponentProps<'div'>) { return <div data-slot="card" className={cn('rounded-2xl border border-[#e4e9e5] bg-white shadow-[0_3px_20px_rgba(21,48,36,.035)]', className)} {...props} /> }
...
function CardDescription({ className, ...props }: React.ComponentProps<'p'>) { return <p data-slot="card-description" className={cn('text-sm text-[#77847c]', className)} {...props} /> }
